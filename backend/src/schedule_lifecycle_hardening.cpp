...
std::string canonicalEmail(std::string value) {
    return cff::schedule_lifecycle::canonicalEmail(std::move(value));
}
...
bool parseWeekPath(const std::string &path,
                   const std::string &suffix,
                   std::string &leagueId,
                   int &week) {
    const std::string prefix = "/api/leagues/";
    const std::string marker = "/lineup/week/";
...
#ifdef CFF_HAS_POSTGRES
#include "schedule_lifecycle_hardening_db.inc"
#include "schedule_lifecycle_hardening_payload.inc"
#include "schedule_lifecycle_hardening_mutations.inc"
#endif

#include "schedule_lifecycle_hardening_advice.inc"
