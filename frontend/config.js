...
(() => {
  const scripts = ['auth-session-sync.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js', 'beta-ui.js', 'league-nav.js', 'workspace-ui.js', 'invite-fix.js', 'footer-links.js'];
  ...
  if (document.readyState === 'loading') {
    ...
    writeStylesheet('league-card-hierarchy.css', 'data-cff-league-card-hierarchy="true"');
  ...
  appendStylesheet('league-card-hierarchy.css', 'cffLeagueCardHierarchy');
