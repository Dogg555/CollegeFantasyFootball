...
(() => {
  ...
  const baseScripts = ['api-client.js', 'authoritative-data.js', 'auth-session-sync.js', 'mutation-consistency.js', 'snake-draft-only.js', 'league-onboarding.js', 'roster-transactions.js', 'waiver-lifecycle.js', 'trade-lifecycle.js', 'scoring-lifecycle.js', 'schedule-lineup-lifecycle.js', 'draft-poll-scope.js', 'draft-lifecycle.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js'];
  const scripts = ['api-client.js', 'authoritative-data.js', 'auth-session-sync.js', 'mutation-consistency.js', 'snake-draft-only.js', 'league-onboarding.js', 'roster-transactions.js', 'waiver-lifecycle.js', 'trade-lifecycle.js', 'scoring-lifecycle.js', 'schedule-lineup-lifecycle.js', 'draft-poll-scope.js', 'draft-lifecycle.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js', 'beta-ui.js', 'league-nav.js', 'workspace-ui.js', 'invite-fix.js', 'footer-links.js', 'landing-refresh.js'];
  const styles = [
