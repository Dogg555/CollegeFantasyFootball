...
(() => {
  ...
  const baseScripts = ['api-client.js', 'authoritative-data.js', 'auth-session-sync.js', 'mutation-consistency.js', 'reliable-sync.js', 'snake-draft-only.js', 'league-onboarding.js', 'roster-transactions.js', 'waiver-lifecycle.js', 'trade-lifecycle.js', 'multi-player-trades.js', 'scoring-lifecycle.js', 'schedule-lineup-lifecycle.js', 'lineup-management.js', 'draft-poll-scope.js', 'draft-lifecycle.js', 'commissioner-controls.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js', 'league-context.js', 'league-context-authority.js', 'league-dashboard-hub.js', 'league-dashboard-runtime-deps.js', 'league-dashboard-runtime.js'];
  const scripts = ['api-client.js', 'authoritative-data.js', 'auth-session-sync.js', 'mutation-consistency.js', 'reliable-sync.js', 'snake-draft-only.js', 'league-onboarding.js', 'roster-transactions.js', 'waiver-lifecycle.js', 'trade-lifecycle.js', 'multi-player-trades.js', 'scoring-lifecycle.js', 'schedule-lineup-lifecycle.js', 'lineup-management.js', 'draft-poll-scope.js', 'draft-lifecycle.js', 'commissioner-controls.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js', 'league-context.js', 'league-context-authority.js', 'league-dashboard-hub.js', 'league-dashboard-runtime-deps.js', 'league-dashboard-runtime.js', 'beta-ui.js', 'league-nav.js', 'workspace-ui.js', 'invite-fix.js', 'footer-links.js', 'landing-refresh.js'];
  const styles = [
