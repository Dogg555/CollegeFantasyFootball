...
(() => {
  const scripts = ['api-client.js', 'authoritative-data.js', 'mutation-consistency.js', 'auth-session-sync.js', 'draft-poll-scope.js', 'polish-core.js', 'polish-forms.js', 'polish-state.js', 'beta-ui.js', 'league-nav.js', 'workspace-ui.js', 'invite-fix.js', 'footer-links.js'];
